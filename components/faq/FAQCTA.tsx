export default function FAQCTA() {
    return (
        <div className="w-full bg-[#150a0a] border-t border-white/10 py-20 px-4 mt-auto">
            <div className="max-w-[960px] mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button className="border border-white/15 hover:border-white text-white font-bold h-12 px-8 rounded-lg uppercase tracking-wide transition-all bg-transparent flex items-center justify-center gap-2">
