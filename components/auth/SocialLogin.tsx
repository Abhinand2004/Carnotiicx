    ...
    return (
        <>
            <div className="relative flex py-2 items-center">
                <div className="flex-grow border-t border-[#472426]"></div>
                <span className="flex-shrink-0 mx-4 text-xs font-bold text-text-muted uppercase tracking-widest">
                    Or join with
                </span>
                <div className="flex-grow border-t border-[#472426]"></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center h-12 bg-[#2a1718] border border-[#472426] hover:bg-[#351d1e] hover:border-text-muted text-white rounded-lg transition-all duration-300 group">
                    <svg
                        className="w-5 h-5 mr-3 transition-opacity opacity-80 group-hover:opacity-100"
                        fill="currentColor"
                        viewBox="0 0 24 24"
