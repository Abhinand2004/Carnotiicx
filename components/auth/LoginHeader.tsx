...
export default function LoginHeader() {
    return (
        <header className="relative z-20 flex items-center justify-between px-6 py-6 md:px-12 w-full max-w-7xl mx-auto">
            <Link href="/" className="flex items-center gap-3 text-white group cursor-pointer">
            ...
            <Link
                href="/contact"
                className="hidden md:flex text-sm font-bold text-white hover:text-primary transition-colors"
            >
                Contact Support
            </Link>
        </header>
